import { ReactIcon, Node, Express, Pg } from ".";
const Invoice = () => {
  return (
    <article className="tablet:grid tablet:grid-cols-2 tablet:gap-x-[5rem]">
      <div className="flex flex-col border-dashed border border-AD1FEA  rounded-b ">
      ...
      <div className="mt-6 tablet:mt-0">
        <div className="tags flex justify-between">
          <div className="bg-EAEAEB rounded-[4px] flex justify-between items-center border border-AD1FEA">
            <span className="bg-AD1FEA rounded-[4px] border h-full w-8"></span>
        ...
        <ul className="bg-203A4C p-3 mt-4 gap-y-6 flex flex-col">
          ...
          <li data-icon="🔥">Create, read, update, and delete invoices</li>
          <li data-icon="🔥">
        ...
        <div className="flex justify-between px-2 tablet:px-0 ">
          <button className="rounded-full flex justify-center items-center border border-dashed bg-AD1FEA  hover:bg-00aecb px-4 py-2 laptop:px-6 laptop:py-3 mt-4 transition-all duration-300">
            <a
              href="https://invoicesv1-production.up.railway.app/
                  "
              target="_blank"
              rel="noreferrer"
            >
