...
const Hero = () => {
  return (
    <section className="hero mt-40 px-8 tablet:px-10 laptop:px-48 relative">
      <div className="flex">
        ...
        <div className="flex flex-col gap-y-2 px-[25px] font-monoton tablet:[35px] laptop:px-[55px] uppercase">
          ...
          {/* <div
            className="text-heading-1 text-222 bg-00aecb h-16 flex items-center pl-4 rounded
          border-dashed border-2 border-222
          "
          >
            Realiable
          ...
          {/* <div
            className="text-heading-1 text-222 bg-00aecb h-16 pl-4 pr-8 flex items-center rounded
          border-dashed border-2 border-222
          "
          >
            Maintainable
          </div> */}
          {/* <div className="text-heading-1 text-FFFF h-16 flex items-center border border-dashed pl-4 py-4 ">
            Software
          </div> */}
          <Button>
